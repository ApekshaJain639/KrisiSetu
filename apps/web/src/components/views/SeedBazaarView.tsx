  ...
  const handleReserve = async (item: SeedHub) => {
    ...
    try {
      const res = await reserveSeedStock({
        ...
        fruits_id: fruitsId || "KA-FRUITS-2024-9981",
